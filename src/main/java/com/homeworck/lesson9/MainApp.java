...
public class MainApp {
    ...
    private static void transactionAndStatementEx() throws SQLException {
        connection.setAutoCommit(false);
        for (int i = 0; i < 1000; i++) {
            preparedStatement.setString(1,"Bob" + (i + 1));
            preparedStatement.setInt(2,50);
    ...
    private static void deleteEx() throws SQLException {
        statement.executeUpdate("DELETE FROME students WHERE id = 3");
    }
